...
# execute the routes
from . import history_route, login_route, register_route, portfolio_route, lesson_route

blueprints=[history_route_1,register_route_1,login_route_1, portfolio_route_1,lesson_route_1]
