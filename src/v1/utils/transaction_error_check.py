...
def transaction_error_check(data, user):
    ...
    if action == "buy":
        ...
        if response["code"] == 200:
            ...
            if not stock:
                ...
                response =  {"code": 400, "message": "quantity must be an integer!", "data": {}}
            elif num_shares < 1:
                response = {"code": 400, "message": "Invalid shares", "data": {}}
            # Create a datetime object in UTC
                ...
                if response["code"] == 200 and (num_shares * price) > user.cash: 
                    return {"error":{"code": 400, "message": "Cannot afford", "data":{}}}
            
        else:
            response = {"code": 302, "message": "To be implemented", "data": {}}
        return response